 ...
 */
import { findWinners } from './hand-eval.js';
/**
 ...
 */
export function awardPots(potState, hands, foldedPlayers) {
    const awards = [];
    const allPots = [
 ...
 */
export function consolidateAwards(awards) {
 ...
 */
export function hasSidePots(potState) {
